      ...
      <main className="px-5 pt-4">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-1 text-[11px] font-medium text-emerald-700/80 leading-relaxed">
                  {language === 'zh' ? '参与 GeneFlare 社区治理、研究投票及节点验证行为。' : 'Activity in GeneFlare governance, research voting, and node validation.'}
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 text-center px-8 pb-12">
          <p className="text-xs text-slate-400 leading-relaxed font-medium">
            {language === 'zh' 
              ? '您的数字身份完全由私钥控制，GeneFlare 不会存储您的身份原文。所有验证均通过 ZK-Flare 协议在链上完成。'
              : 'Your digital identity is controlled entirely by your private keys. GeneFlare does not store your raw identity data. All verifications are ZK-Proofs on-chain.'
            }
          </p>
        </div>
      </main>
